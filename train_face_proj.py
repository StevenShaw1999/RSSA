...
from model import Generator, Extra, Projection_module, avg_conv
...
if __name__ == "__main__":
    ...
    parser.add_argument('--exp_name', type=str, default='sketches')
